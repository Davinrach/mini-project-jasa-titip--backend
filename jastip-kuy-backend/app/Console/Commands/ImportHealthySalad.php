...
class ImportHealthySalad extends Command
{
    protected $signature = 'import:salad-menu';
    protected $description = 'Import menu salad dari file CSV ke tabel products';

    public function handle()
    {
        $filename = 'menu_Greenly_Healthy_Salad_Bowl_Juice-GM_1_1.csv';
